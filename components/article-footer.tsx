...
const ArticleFooter = () => {
  ...
  return (
    <>
      ...
      {/* TODO: Giscus'ni security-journey repo'si uchun sozlang — https://giscus.app
          dan yangi repoId va categoryId oling (joriy ID'lar devops-journey'niki). */}
      <Giscus
        key={theme}
        id="comments"
        repo="ismoilovdevml/security-journey"
        repoId="R_kgDOKEbY2g"
        category="General"
